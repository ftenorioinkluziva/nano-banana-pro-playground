  ...
  return (
    <div className="fixed bottom-6 right-6 bg-zinc-900/95 border border-zinc-700/50 rounded-lg p-4 shadow-2xl max-w-sm z-50 backdrop-blur-sm">
      <div className="flex gap-3">
        ...
        <div>
          <h3 className="text-zinc-200 font-semibold text-sm mb-1">Kie API Key Required</h3>
          <p className="text-zinc-400 text-xs leading-relaxed">
            Creato requires a Kie API key to generate images. Please add your{" "}
            <code className="bg-zinc-800 px-1.5 py-0.5 rounded text-zinc-300">KIEAI_API_KEY</code> as an
          ...
          >
            Learn how to get a Kie API key →
          </a>
        </div>
      </div>
    </div>
